...
public class BroadleafCheckoutController extends AbstractCheckoutController {
    ...
    public String saveSingleShip(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        //option 1 i standard, look in db SELECT * FROM broadleaf.blc_fulfillment_option;
        FulfillmentOption fulfillmentOption = fulfillmentOptionService.readFulfillmentOptionById((long) 1);//shippingForm.getFulfillmentOptionId());
