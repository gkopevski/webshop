...
public class MIRPaymentServiceActivity extends BaseActivity<CheckoutContext> {
    
    private static final Log LOG = LogFactory.getLog(MIRPaymentServiceActivity.class);
