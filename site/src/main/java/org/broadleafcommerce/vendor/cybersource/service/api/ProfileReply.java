...
public class ProfileReply  implements java.io.Serializable {
    ...
    private org.broadleafcommerce.vendor.cybersource.service.api.RuleResultItems rulesTriggered;
    ...
    public ProfileReply(
           ...
           org.broadleafcommerce.vendor.cybersource.service.api.RuleResultItems rulesTriggered) {
     ...
     */
    public org.broadleafcommerce.vendor.cybersource.service.api.RuleResultItems getRulesTriggered() {
        return rulesTriggered;
    }
     ...
     */
    public void setRulesTriggered(org.broadleafcommerce.vendor.cybersource.service.api.RuleResultItems rulesTriggered) {
        this.rulesTriggered = rulesTriggered;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:schemas-cybersource-com:transaction-data-1.49", "RuleResultItems"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
